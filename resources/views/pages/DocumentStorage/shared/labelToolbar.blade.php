{{--
| TÀI LIỆU - THANH CÔNG CỤ TRANG IN NHÃN (port từ labelToolbar của WMS)
|
...
|
| Biến truyền vào:
|   $recordId    id tài liệu đang in nhãn
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var DPI = {{ (int) $lblDpi }};
        var PRINTER_KEY = 'lms.zebra.printerUid';
