    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column mt-5" data-widget="treeview" role="menu"
                ...
                <!-- User Policy -->
                @if (user_has_permission(session('user')['userId'] ?? null, 'admin.view', 'boolean'))
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            @if (user_has_permission(session('user')['userId'] ?? null, 'user.view', 'boolean'))
                                <li class="nav-item"><a href="{{ route('pages.User.user.list') }}" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>User</p>
                                    </a></li>
                            @endif
                            @if (user_has_permission(session('user')['userId'] ?? null, 'role.view', 'boolean'))
                                <li class="nav-item"><a href="{{ route('pages.User.role.list') }}" class="nav-link"><i
                                            class="far fa-circle nav-icon"></i>
                                        <p>Nhóm Quyền</p>
                                    </a></li>
                            @endif
                            @if (user_has_permission(session('user')['userId'] ?? null, 'permission.view', 'boolean'))
                    ...
                    @if (user_has_permission(session('user')['userId'] ?? null, 'auditTrail.view', 'boolean'))
